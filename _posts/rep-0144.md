REP: 144 Title: ROS Package Naming Author: Vincent Rabaud
\<vincent.rabaud@gmail.com\> Status: Active Type: Informational
Content-Type: text/x-rst Created: 28-Jan-2015 Post-History: 21-Dec-2018
...
[^2]: Browsing ROS Packages (<https://index.ros.org/packages/>)
